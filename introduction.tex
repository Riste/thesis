...
\end{itemize}
%Contribution from the study described in section \ref{sec:topical-desc}
%\begin{itemize}
%\item Algorithm for deriving topical descriptions for scenes obtained from user tags.
%\item Quantitative analysis of the added value of the derived topical description for fragment retrieval.
%\end{itemize}
